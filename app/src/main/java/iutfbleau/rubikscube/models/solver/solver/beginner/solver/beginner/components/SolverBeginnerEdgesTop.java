...
public class SolverBeginnerEdgesTop extends SolverComponent
{
	...
	{
		int color = cube.getFace(face).getColor();
		if (cube.getFace(face).getColor(0,1) == color)
		{
			return true;
		}
		return false;
